    ...
    <div>
      ...
      <div className='flex flex-row items-center'>
        ...
        <div className="basis-8/12">
          <h1 className='pl-20 text-loil-light italic text-xl font-medium'>Helping you obtain, retain and engage a loyal patient following</h1>
        </div>
        ...
        <div className='mr-20 prose prose xl mx-auto flex justify-between flex-col sm:flex-row text-black/70 font-sans text-xl font-medium'>
            ...
            <Link href="/" className='no-underline hover:text-black/90'>Our Team</Link>
            <Link href="/" className='no-underline hover:text-black/90'>Our Services</Link>
            <Link href="/" className='no-underline hover:text-black/90'>Contact Us</Link>
